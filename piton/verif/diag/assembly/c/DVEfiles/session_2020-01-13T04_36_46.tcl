...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 35} {1873 993}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 436} {height 706} {dock_state left} {dock_on_new_line true} {child_hier_colhier 383} {child_hier_coltype 81} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 513]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 513
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 730
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 512} {height 706} {dock_state left} {dock_on_new_line true} {child_data_colvariable 251} {child_data_colvalue 136} {child_data_coltype 153} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1865} {height 153} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{+wait_cycle_to_kill=10 +dowarningfinish +doerrorfinish +spc_pipe=0 +vcs+dumpvarsoff +TIMEOUT=50000 +tg_seed=0 +asm_diag_name=ubmark-masked-filter.c +dv_root=/home/kaifengx/anycore/piton}}
...
gui_sim_run Ucli -exe simv -args { +wait_cycle_to_kill=10 +dowarningfinish +doerrorfinish +spc_pipe=0 +vcs+dumpvarsoff +TIMEOUT=50000 +tg_seed=0 +asm_diag_name=ubmark-masked-filter.c +dv_root=/home/kaifengx/anycore/piton -ucligui} -dir /home/kaifengx/anycore/build/manycore/rel-0.1 -nosource
}
}
...
catch {gui_list_expand -id ${Hier.1} cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2}
catch {gui_list_expand -id ${Hier.1} cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute}
catch {gui_list_select -id ${Hier.1} {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.calu}}
gui_view_scroll -id ${Hier.1} -vertical -set 744
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.calu}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.calu.shiftFlagsBuffer }}
gui_view_scroll -id ${Data.1} -vertical -set 281
...
gui_open_source -id ${Source.1}  -replace -active cmp_top.l2_mon /home/kaifengx/anycore/piton/verif/env/manycore/l2_mon.tmp.v
gui_view_scroll -id ${Source.1} -vertical -set 3450
