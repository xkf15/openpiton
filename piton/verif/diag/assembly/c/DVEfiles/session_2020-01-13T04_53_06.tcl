...
# DVE full session
# Saved on Mon Jan 13 04:53:06 2020
# Designs open: 1
#   Sim: /home/kaifengx/anycore/build/manycore/rel-0.1/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: cmp_top.network_mon
#   Group count = 3
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 35} {1872 992}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 435} {height 706} {dock_state left} {dock_on_new_line true} {child_hier_colhier 383} {child_hier_coltype 81} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 512]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 512
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 706
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 511} {height 706} {dock_state left} {dock_on_new_line true} {child_data_colvariable 251} {child_data_colvalue 136} {child_data_coltype 153} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1864} {height 152} {dock_state bottom} {dock_on_new_line true}}
...
gui_load_child_values {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.calu}
...
set _session_group_5 simple_complex_fp.calu
gui_sg_create "$_session_group_5"
set simple_complex_fp.calu "$_session_group_5"
...
catch {gui_list_select -id ${Hier.1} {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.mux}}
gui_view_scroll -id ${Hier.1} -vertical -set 664
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {cmp_top.system.chip.tile0.g_anycore_core.core.coreTop.exePipe2.execute.simple_complex_fp.mux}
...
gui_open_source -id ${Source.1}  -replace -active cmp_top.network_mon /home/kaifengx/anycore/piton/verif/env/manycore/manycore_network_mon.tmp.v
