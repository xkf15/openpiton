...
# DVE full session
# Saved on Thu Jan 9 21:18:40 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 35} {1915 1035}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 450]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 450
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 449} {height 737} {dock_state left} {dock_on_new_line true} {child_hier_colhier 417} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 437]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 437
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 737
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 436} {height 737} {dock_state left} {dock_on_new_line true} {child_data_colvariable 228} {child_data_colvalue 114} {child_data_coltype 96} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
set _session_group_3 l15
gui_sg_create "$_session_group_3"
set l15 "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { cmp_top.system.chip.tile0.l15.chipid cmp_top.system.chip.tile0.l15.clk cmp_top.system.chip.tile0.l15.config_csm_en cmp_top.system.chip.tile0.l15.config_hmt_base cmp_top.system.chip.tile0.l15.config_home_alloc_method cmp_top.system.chip.tile0.l15.config_l15_read_res_data_s3 cmp_top.system.chip.tile0.l15.config_system_tile_count cmp_top.system.chip.tile0.l15.config_system_tile_count_5_0 cmp_top.system.chip.tile0.l15.coreid_x cmp_top.system.chip.tile0.l15.coreid_y cmp_top.system.chip.tile0.l15.dmbr_l15_stall cmp_top.system.chip.tile0.l15.l15_config_req_address_s2 cmp_top.system.chip.tile0.l15.l15_config_req_rw_s2 cmp_top.system.chip.tile0.l15.l15_config_req_val_s2 cmp_top.system.chip.tile0.l15.l15_config_write_req_data_s2 cmp_top.system.chip.tile0.l15.l15_dmbr_l1missIn cmp_top.system.chip.tile0.l15.l15_dmbr_l1missTag cmp_top.system.chip.tile0.l15.l15_dmbr_l2missIn cmp_top.system.chip.tile0.l15.l15_dmbr_l2missTag cmp_top.system.chip.tile0.l15.l15_dmbr_l2responseIn cmp_top.system.chip.tile0.l15.l15_transducer_ack cmp_top.system.chip.tile0.l15.l15_transducer_address cmp_top.system.chip.tile0.l15.l15_transducer_atomic cmp_top.system.chip.tile0.l15.l15_transducer_blockinitstore cmp_top.system.chip.tile0.l15.l15_transducer_cross_invalidate cmp_top.system.chip.tile0.l15.l15_transducer_cross_invalidate_way cmp_top.system.chip.tile0.l15.l15_transducer_data_0 cmp_top.system.chip.tile0.l15.l15_transducer_data_1 cmp_top.system.chip.tile0.l15.l15_transducer_data_2 cmp_top.system.chip.tile0.l15.l15_transducer_data_3 cmp_top.system.chip.tile0.l15.l15_transducer_error cmp_top.system.chip.tile0.l15.l15_transducer_f4b cmp_top.system.chip.tile0.l15.l15_transducer_header_ack cmp_top.system.chip.tile0.l15.l15_transducer_inval_address_15_4 cmp_top.system.chip.tile0.l15.l15_transducer_inval_dcache_all_way cmp_top.system.chip.tile0.l15.l15_transducer_inval_dcache_inval cmp_top.system.chip.tile0.l15.l15_transducer_inval_icache_all_way cmp_top.system.chip.tile0.l15.l15_transducer_inval_icache_inval cmp_top.system.chip.tile0.l15.l15_transducer_inval_way cmp_top.system.chip.tile0.l15.l15_transducer_l2miss cmp_top.system.chip.tile0.l15.l15_transducer_noncacheable cmp_top.system.chip.tile0.l15.l15_transducer_prefetch cmp_top.system.chip.tile0.l15.l15_transducer_returntype cmp_top.system.chip.tile0.l15.l15_transducer_threadid cmp_top.system.chip.tile0.l15.l15_transducer_val cmp_top.system.chip.tile0.l15.noc1_out_data cmp_top.system.chip.tile0.l15.noc1_out_rdy cmp_top.system.chip.tile0.l15.noc1_out_val cmp_top.system.chip.tile0.l15.noc2_in_data cmp_top.system.chip.tile0.l15.noc2_in_rdy cmp_top.system.chip.tile0.l15.noc2_in_val cmp_top.system.chip.tile0.l15.noc3_out_data cmp_top.system.chip.tile0.l15.noc3_out_rdy cmp_top.system.chip.tile0.l15.noc3_out_val cmp_top.system.chip.tile0.l15.rst_n cmp_top.system.chip.tile0.l15.rtap_srams_bist_command cmp_top.system.chip.tile0.l15.rtap_srams_bist_data cmp_top.system.chip.tile0.l15.srams_rtap_data cmp_top.system.chip.tile0.l15.transducer_l15_address cmp_top.system.chip.tile0.l15.transducer_l15_amo_op cmp_top.system.chip.tile0.l15.transducer_l15_blockinitstore cmp_top.system.chip.tile0.l15.transducer_l15_blockstore cmp_top.system.chip.tile0.l15.transducer_l15_csm_data cmp_top.system.chip.tile0.l15.transducer_l15_data cmp_top.system.chip.tile0.l15.transducer_l15_data_next_entry cmp_top.system.chip.tile0.l15.transducer_l15_invalidate_cacheline cmp_top.system.chip.tile0.l15.transducer_l15_l1rplway cmp_top.system.chip.tile0.l15.transducer_l15_nc cmp_top.system.chip.tile0.l15.transducer_l15_prefetch cmp_top.system.chip.tile0.l15.transducer_l15_req_ack cmp_top.system.chip.tile0.l15.transducer_l15_rqtype cmp_top.system.chip.tile0.l15.transducer_l15_size cmp_top.system.chip.tile0.l15.transducer_l15_threadid cmp_top.system.chip.tile0.l15.transducer_l15_val }
...
catch {gui_list_select -id ${Hier.1} {cmp_top.system.chip.tile0.l15}}
gui_view_scroll -id ${Hier.1} -vertical -set 333
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {cmp_top.system.chip.tile0.l15}
