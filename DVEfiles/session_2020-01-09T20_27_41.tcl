...
# DVE full session
# Saved on Thu Jan 9 20:27:41 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 35} {1917 1037}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 451} {height 737} {dock_state left} {dock_on_new_line true} {child_hier_colhier 417} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 438} {height 737} {dock_state left} {dock_on_new_line true} {child_data_colvariable 228} {child_data_colvalue 114} {child_data_coltype 96} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1909} {height 166} {dock_state bottom} {dock_on_new_line true}}
